...
class Agent:
    ...
    def getAction(self, state, filter=None, train=False):
        """
...
class Actions:
    ...
    def getPossibleActions(config, walls, filter=None, train=False):
        possible = []
        x, y = config.pos
...
class GameStateData:
    ...
    def __init__( self, prevState = None ):
        ...
        if prevState != None:
            ...
            self.countEaten = prevState.countEaten
            self.interventions = prevState.interventions
            self.times = prevState.times
    ...
    def initialize( self, layout, numGhostAgents ):
        ...
        self.countEaten = [0 for a in self.agentStates]
...
class Game:
    ...
    def run( self ):
        ...
        while not self.gameOver:
            ...
            self.unmute()
            if observation.data.interventions != self.state.data.interventions:
                self.state.data.interventions = observation.data.interventions
            if observation.data.times != self.state.data.times:
                self.state.data.times = observation.data.times
