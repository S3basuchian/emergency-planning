...
main(int argc, char* argv[])
{
  ...
  consumerHelper.SetAttribute("Frequency", StringValue("3")); // 3 interests a second
  consumerHelper.Install(nodes.Get(0));
  consumerHelper.SetPrefix("/movie/hp");
  ...
  apps.Stop(Seconds(20.0)); // stop the consumer app at 20 seconds mark
